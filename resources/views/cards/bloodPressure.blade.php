<div class="card">
    <div class="card-block">
        ...
        <div class="text-center">
            <i class="flaticon-blood-pressure-gauge fa-4x" aria-hidden="true"></i>
        </div>
        <div class="card-block">
            <button id="view-bloodPressure-button" class="btn btn-primary" data-toggle="modal" data-target="#view-bloodPressure-modal">View Log</button>
        </div>
    </div>
</div>
