...
let week = require('./json/weight-week.json');
let month = require('./json/weight-month.json');
let year = require('./json/weight-year.json');
...
if (document.getElementById('weight-graph')) {
    ReactDOM.render(<WeightGraph />, document.getElementById('weight-graph'));
}