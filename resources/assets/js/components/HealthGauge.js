...
export default class HealthGauge extends Component{
	constructor(props) {
		super(props);
...
if (document.getElementById('clientHealthGauge')) {
    ReactDOM.render(<HealthGauge />, document.getElementById('clientHealthGauge'));
}
