...
// document.getElementById("spinner-steps").className = "loader";
...
export default class StepsBarGraph extends Component {
    constructor(props) {
		super(props);
...
if (document.getElementById('steps-bar-graph')) {
    ReactDOM.render(<StepsBarGraph />, document.getElementById('steps-bar-graph'));
    // document.getElementById("spinner-steps").className = "";
}

// document.getElementById('view-steps-button').onclick = function() {
//    ReactDOM.render(<StepsBarGraph />, document.getElementById('steps-bar-graph'));
